...
namespace TestDBReadWriteDisplay {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class PeopleDataTable : global::System.Data.TypedTableBase<PeopleRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public PeopleRow AddPeopleRow(string FirstName, string LastName, int Age, string Information) {
        ...
        public partial class PeopleRow : global::System.Data.DataRow {
            ...
            public string Information {
                get {
                    try {
                        return ((string)(this[this.tablePeople.InformationColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Information\' in table \'People\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tablePeople.InformationColumn] = value;
                }
            }
            ...
            public bool IsInformationNull() {
                return this.IsNull(this.tablePeople.InformationColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetInformationNull() {
                this[this.tablePeople.InformationColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace TestDBReadWriteDisplay.Database1DataSetTableAdapters {
    ...
    public partial class PeopleTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `People` WHERE ((`ID` = ?) AND ((? = 1 AND `FirstName` IS NULL) OR (`" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `People` (`FirstName`, `LastName`, `Age`, `Information`) VALUES (?, ?" +
                ", ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `People` SET `FirstName` = ?, `LastName` = ?, `Age` = ?, `Information` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `FirstName` IS NULL) OR (`FirstName` = ?)) AND ((? = 1 AND `LastName` IS NULL) OR (`LastName` = ?)) AND ((? = 1 AND `Age` IS NULL) OR (`Age` = ?)))";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Information", global::System.Data.OleDb.OleDbType.LongVarWChar, 0, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Information", global::System.Data.DataRowVersion.Current, false, null));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=C:\\Users\\ECS\\Documents\\Database1.ac" +
                "cdb";
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, FirstName, LastName, Age, Information FROM People";
        ...
        public virtual int Insert(string FirstName, string LastName, global::System.Nullable<int> Age, string Information) {
            if ((FirstName == null)) {
        ...
        public virtual int Update(string FirstName, string LastName, global::System.Nullable<int> Age, string Information, int Original_ID, string Original_FirstName, string Original_LastName, global::System.Nullable<int> Original_Age) {
            if ((FirstName == null)) {
